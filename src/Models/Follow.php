...
class Follow
{
     ...
     */
    public static function getFollowers(int $accountId, int $limit = 40, int $offset = 0): Generator
    {
     ...
     */
    public static function getFollowing(int $accountId, int $limit = 40, int $offset = 0): Generator
    {
        $sql = "SELECT f.*, a.id as account_id, a.username, a.display_name, a.avatar_url, a.bio,
                       a.is_local, a.is_locked, a.is_bot, a.followers_count, a.following_count, a.statuses_count
                FROM follows f
